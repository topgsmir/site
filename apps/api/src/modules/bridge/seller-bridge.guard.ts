...
@Injectable()
export class SellerBridgeGuard implements CanActivate {
  constructor(private readonly auth: RequestAuthenticationService, private readonly prisma: PrismaService) {}
