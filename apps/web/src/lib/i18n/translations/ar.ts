export const ar = {
  ...
  auth: {
    ...
    description: "أدخل بريدك الإلكتروني أو اسم المستخدم أو رقم الهاتف للمتابعة.",
    fullName: "الاسم",
    identifier: "البريد الإلكتروني أو اسم المستخدم أو رقم الهاتف",
    methodUnavailable: "طريقة الدخول هذه غير متاحة حاليًا.",
    phoneInvalid: "أدخل رقم هاتف إيرانيًا صحيحًا.",
    code: "رمز الرسالة",
    codeDigit: "رقم الرمز",
    codeSentTo: "أُرسل الرمز إلى",
    codeExpiresIn: "تنتهي صلاحيته خلال",
    codeExpired: "انتهت صلاحية الرمز. اطلب رمزًا جديدًا.",
    resendCode: "إرسال رمز جديد",
    changePhone: "تغيير الرقم",
    sendCode: "إرسال الرمز",
    verifyCode: "الدخول بالرمز",
    firstPhoneHint: "هذا الرقم جديد. أضف اسمك لإكمال إنشاء الحساب.",
    firstEmailHint: "إذا كانت هذه زيارتك الأولى، أضف اسمك للمتابعة. إذا كان لديك حساب، تحقق من كلمة المرور.",
    invalidCredentials: "تحقق من البريد الإلكتروني أو اسم المستخدم أو كلمة المرور وحاول مجددًا.",
    methodsError: "تعذر تحميل طرق الدخول. حدّث الصفحة وحاول مجددًا.",
