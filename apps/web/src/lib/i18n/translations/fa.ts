export const fa = {
  ...
  auth: {
    ...
    methodUnavailable: "این روش ورود در حال حاضر غیرفعال است.",
    phoneInvalid: "شماره موبایل ایران را کامل و درست وارد کنید.",
    code: "کد پیامک",
    codeDigit: "رقم کد",
    codeSentTo: "کد به این شماره فرستاده شد:",
    codeExpiresIn: "مهلت استفاده:",
    codeExpired: "مهلت این کد تمام شده است. کد تازه بگیرید.",
    resendCode: "ارسال کد تازه",
    changePhone: "تغییر شماره",
    sendCode: "ارسال کد",
    verifyCode: "ورود با کد",
    firstPhoneHint: "این شماره تازه است. برای تکمیل ساخت حساب، نام خود را وارد کنید.",
    firstEmailHint: "اگر نخستین بار است، نام خود را وارد کنید. اگر حساب دارید، رمز عبور را بررسی کنید.",
    invalidCredentials: "ایمیل، نام کاربری یا رمز عبور را بررسی کنید و دوباره تلاش کنید.",
    methodsError: "روش‌های ورود دریافت نشد. صفحه را تازه‌سازی کنید.",
    email: "ایمیل",
    password: "رمز عبور",
    loginAction: "ادامه",
