...
export const metadata: Metadata = { title: "ویرایش مقاله", robots: { index: false, follow: false } };
...
export default async function SellerBlogEditorPage({ params }: { params: Promise<{ locale: string; id: string }> }) {
  ...
  return <BlogEditor postId={id} backHref={`/${locale}/seller-dashboard?section=blog`} />;
}
