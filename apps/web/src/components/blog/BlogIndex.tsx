        ...
        {featured ? (
          <article className="journal-feature">
            ...
            <div>
              ...
              <h2><Link href={`/${locale}/blog/${featured.slug}` as Route}>{featured.title}</Link></h2>
              ...
              <Link className="journal-read" href={`/${locale}/blog/${featured.slug}` as Route}>{copy.read} <span aria-hidden="true">↗</span></Link>
            </div>
          </article>
        ) : (
