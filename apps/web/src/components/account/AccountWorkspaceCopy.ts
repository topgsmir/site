export const WORKSPACE_COPY = {
  ...
  fa: {
    ...
    order: "سفارش", products: "محصولات", amount: "مبلغ", status: "وضعیت", quantity: "تعداد", expand: "دیدن اقلام", chat: "پشتیبانی", openingChat: "در حال باز کردن گفت‌وگو…", chatError: "گفت‌وگوی این سفارش باز نشد. دوباره تلاش کنید.", footer: "همراه شما در تعمیر بعدی.",
