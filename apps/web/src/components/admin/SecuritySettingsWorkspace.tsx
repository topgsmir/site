...
const groups = [
  ...
  { name: ["Platform", "پلتفرم", "المنصة"], actions: ["sms_configuration", "goghdi_configuration", "media_admin", "bridge", "signed_ticket", "ai_profile", "ai_profile_test", "ai_run", "analytics"] }
] as const;
...
const actionDescriptions: Record<string, [string, string, string]> = {
  ...
  media_admin: ["Searching, trashing, restoring, and inspecting managed uploads.", "جست‌وجو، انتقال به زباله‌دان، بازیابی و بررسی بارگذاری‌های مدیریت‌شده.", "البحث في الملفات المُدارة ونقلها إلى المهملات واستعادتها وفحصها."],
