...
const sections = [
  ...
  { key: "amadastShipment", label: "amadastShipment" },
      ...
      <section className={styles.detailArea} aria-label={locale === "fa" ? "سوابق سفارش" : locale === "ar" ? "سجلات الطلب" : "Order records"}>
        ...
        <div className={styles.detailLayout}>
          ...
          <div className={styles.detailContent}>
            ...
            {section === "delivery" ? <div className={styles.recordList}><RecordSection title={c.shippingAddress} value={details.shippingAddress} locale={locale} empty={c.missing} /><RecordSection title={c.shipment} value={details.shipment} locale={locale} empty={c.missing} />{details.amadastShipment ? <RecordSection title={c.amadastShipment} value={details.amadastShipment} locale={locale} empty={c.missing} /> : null}</div> : null}
